    ...
    var St = {
            ...
            limitCanvas: function () {
                ...
                a &&
                    ...
                    (a = (o = Yt({ aspectRatio: l, width: a, height: t }))
                        .width),
                    (t = o.height),
                    (e = (l = Yt({ aspectRatio: l, width: e, height: i }))
                        .width),
                    (i = l.height),
                    (h.minWidth = a),
                    (h.minHeight = t),
                ...
                st(t, {
                    ...
                    pt(
                        ...
                        st(
                            ...
                            Nt(
                                st(
                                    { translateX: t.left, translateY: t.top },
                                    t,
                                ),
                            ),
                        ),
            ...
            limitCropBox: function () {
                ...
                a &&
                    ...
                    0 < c &&
                        ...
                        (i = Math.min(l, i))),
                    0 < s &&
                        ((a = (o = Yt({ aspectRatio: s, width: a, height: t }))
                            .width),
                        (t = o.height),
                        (e = (s = Yt({ aspectRatio: s, width: e, height: i }))
                            .width),
                        (i = s.height)),
                    (h.minWidth = a),
                    (h.minHeight = t),
            ...
            cropStart: function (t) {
                ...
                this.disabled ||
                    ...
                    $.test(a) &&
                        ...
                        (this.cropping = !1),
                        a === H &&
                            ((this.cropping = !0), ut(this.dragBox, u))));
            },
            cropMove: function (t) {
                var e,
                    i = this.action;
                !this.disabled &&
                    ...
                    t.preventDefault(),
                    !1 !==
                        kt(this.element, M, { originalEvent: t, action: i }) &&
                        (t.changedTouches
                            ? ht(t.changedTouches, function (t) {
            ...
            change: function (t) {
                ...
                !h && t.shiftKey && (h = d && l ? d / l : 1),
                    0 < e.viewMode &&
                        ...
                        (v =
                            g +
                            Math.min(a.height, i.height, i.top + i.height)));
                function b(t) {
                    switch (t) {
                        case N:
                            p + D.x > f && (D.x = f - p);
            ...
            getCroppedCanvas: function () {
                ...
                var e,
                    ...
                    m =
                        ...
                        (f = void 0 === x || x),
                        (v =
                            void 0 === (p = y.imageSmoothingQuality)
                                ? "low"
                                : p),
                        ...
                        (y = (x = document.createElement("canvas")).getContext(
                            "2d",
                        )),
                        (e = Yt({ aspectRatio: r, width: d, height: l })),
                        (r = Yt(
                            { aspectRatio: r, width: p, height: i },
                            "cover",
                        )),
                        ...
                        (i = Yt(
                            { aspectRatio: a, width: p, height: i },
                            "cover",
                        )),
